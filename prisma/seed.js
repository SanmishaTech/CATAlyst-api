...
async function main() {
  ...
  console.log('2 users created under Client 1');

  // 4. Create Users under Client 2
  console.log('Creating users under Client 2...');
  await prisma.user.create({
    data: {
      name: 'User Two A',
  ...
  console.log('3 users created under Client 2');
